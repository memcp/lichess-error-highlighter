...
def test_played_for_white_side():
    ...
    assert played_for(players, 'white', username) == True
...
def test_played_for_black_side():
    ...
    username = 'player_username'
    assert played_for(players, 'black', username) == True
...
def test_not_played_for_white_side():
    ...
    username = 'player_username'
    assert played_for(players, 'white', username) == False
...
def test_not_played_for_black_side():
    ...
    username = 'player_username'
    assert played_for(players, 'black', username) == False
